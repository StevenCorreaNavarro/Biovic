            ...
            <center>
                ...
                <form action="{{ route('adminasomod.storeasomod') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <input type="text" id="marca" name="marca_id" class="form-control" list="marca-list" value="{{ old('nombre_marca') }}"  required>
                        <datalist id="marca-list" >
                            @foreach ($datoma as $marca)
                                <option value="{{ $marca->id }}" data-id="{{ $marca->marca_id }} " >{{ $marca->nombre_marca }}</option>
                            @endforeach
                        </datalist>
                    </div>
                    <br>
                    <div>
                        ...
                        <input type="text" id="modelo" name="nombre_modelo" class="form-control" list="modelo-list" value="{{ old('nombre_modelo') }}"  required>
                        <datalist id="modelo-list" >
                            @foreach ($datomo as $equipo)
                                <option value="{{ $equipo->nombre_modelo}}" data-id="{{ $equipo->id}} " > {{ $equipo->nombre_modelo }}</option>
                            @endforeach
                        </datalist>
                    </div>
                    <br>
